...
# -*- coding: utf-8 -*-
#
# trepr documentation build configuration file, created by
...
latex_documents = [
    (master_doc, "trepr.tex", "trepr Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "trepr", "trepr Documentation", [author], 1)]
